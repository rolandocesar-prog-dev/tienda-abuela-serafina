...
class OrdenCompra(Base):
    ...
    agencia_origen_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), nullable=True, index=True)  # 🔥 NUEVO
    agencia_destino_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), nullable=False, index=True)
